...
declare global {
  ...
  const { dateToJalali, dateToJalaliString, isoToJalali, jalaliStrToDate, jalaliStrToIso, jalaliToDate, normalizeJalaliDigits, todayJalali }: typeof import('../../utils/jalali')
  ...
  const { defineI18nConfig, defineI18nLocale, defineI18nRoute, useBrowserLocale, useCookieLocale, useI18nPreloadKeys, useLocaleHead, useLocalePath, useLocaleRoute, useRouteBaseName, useSetI18nParams, useSwitchLocalePath }: typeof import('../../node_modules/@nuxtjs/i18n/dist/runtime/composables/index')
  ...
  const { useFilter }: typeof import('../../composables/useFilter')
  const { useFormatDate }: typeof import('../../composables/useFormatDate')
  const { useHydration }: typeof import('../../node_modules/nuxt/dist/app/composables/hydrate')
  const { useI18n }: typeof import('../../node_modules/vue-i18n/dist/vue-i18n')
  ...
  const { usePermission }: typeof import('../../composables/usePermission')
  ...
  const { useTasksStore }: typeof import('../../stores/tasks')
  const { useWeek }: typeof import('../../composables/useWeek')
}
// for type re-export
declare global {
  // @ts-ignore
