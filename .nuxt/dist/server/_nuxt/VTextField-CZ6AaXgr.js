import { toRef, createVNode, withDirectives, createElementVNode, normalizeStyle, normalizeClass, vShow, mergeProps, useId, computed, ref, watch, Fragment, inject, shallowRef, unref, nextTick, cloneVNode } from "vue";
import { b as VSlideYTransition, c as VExpandXTransition } from "./index-DFeFuJj2.js";
import { a as useRender, c as makeComponentProps, b as makeDimensionProps, u as useDimension } from "./VGrid-DYUQajch.js";
import { M as MaybeTransition, y as makeTransitionProps, a as VIcon, o as makeRoundedProps, r as makeLoaderProps, g as useLoader, j as useRounded, z as useBackgroundColor, x as useTextColor, L as LoaderSlot, b as VDefaultsProvider, m as makeDensityProps, e as useDensity, I as Intersect } from "./index-SOHsZWxA.js";
import { g as genericComponent, p as propsFactory, m as makeThemeProps, K as EventProp, J as useLocale, L as callEvent, w as getCurrentInstanceName, D as useProxiedModel, I as IconValue, f as provideTheme, d as useRtl, M as standardEasing, j as convertToUnit, N as wrapInArray, h as getCurrentInstance, E as useToggleScope, O as pick, P as filterInputAttrs, Q as omit } from "../server.mjs";
class Box {
  constructor(_ref) {
    let {
      x,
...
export {
  ...
  forwardRefs as f,
  getTargetBox as g,
  useAutocomplete as h,
  makeVFieldProps as i,
  makeVInputProps as j,
  makeAutocompleteProps as k,
  VInput as l,
...
//# sourceMappingURL=VTextField-CZ6AaXgr.js.map
